...
4. PDF printing needs nothing extra: the installer bundles the embedded PDFium renderer (`resources\pdfium.dll`) next to the agent. Do not install a PDF application for printing.
