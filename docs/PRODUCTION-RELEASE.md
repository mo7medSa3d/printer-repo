...
| 5 | `internal/storage` — dead, misleading DPAPI/FileStore stubs that reported success without storing anything | Package removed (real DPAPI wiring remains documented future work; nothing imported it) |
